...
public class F2 extends ThreadFunctions{
    public F2(int N,double[] x){super(N,x);}
...
//    @Override
//    public void run() {
//        double[] xHalf = new double[x.length/2];
//        System.arraycopy(x,0,xHalf,0,xHalf.length);
//        //double[] Fx = new double[N];
//        double[] Fre = new double[N];
//        double[] Fim = new double[N];
//        double F1re,F2re,F1im,F2im;
...
//        }
//        for (int p = 0; p < N; p++) {
//            FxPar[p+xHalf.length] = Math.abs(Math.sqrt(Math.pow(Fre[p], 2) + Math.pow(Fim[p], 2)));
//        }
//        //return Fx;
//    }
